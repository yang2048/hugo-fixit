...
{{< link href="https://yyovo.com/home" content="🎉🎉记录生活·资源分享·技术交流" card-icon="" card=true >}} 
...
## 推广
{{< tabs type="segment" >}}
{{% tab title="网站搭建" %}}针对中小微企业提供高端定制化网站建设服务，满足您的各种建站需求。{{% /tab %}}
{{% tab title="小程序开发" %}}提供完整的小程序开发解决方案，为企业获客营收创造有利条件。{{% /tab %}}
{{% tab title="业务定制" %}}专业量身定制设计、定制功能、定制后台开发；拥有资深开发团队，追求质量同时保证速度、追求完美，不断提升系统响应速度和稳定性完善的测试流程，达到完美客户体验。{{% /tab %}}
{{< /tabs >}}

## 合作
```yaml
 微信: yyovoim
 邮箱: {{< link "mailto:yy_im@outlook.com" "yy_im@outlook.com" >}}
 官网: {{< link "https://yyovo.com" >}}
 主页: {{< link "https://xdev.cc" >}}
